...
namespace Petecat.ServiceHost
{
    ...
    public class ArticleService
    {
        ...
        public Article PostArticle([ParameterInfo(Source = ParameterSource.Body)] Article article, 
            [ParameterInfo(Source = ParameterSource.QueryString, Alias = "alias")] string id)
        {
            return article;
        }
    }
