...
namespace Files
{
    [DependencyInjectable(Inference = typeof(IReplacement), Singleton = true)]
    public class Replacement : IReplacement
    {
        ...
        public Replacement(IFileSystemExplorer fileSystemExplorer, IStaticFileConfigurer staticFileConfigurer)
        {
